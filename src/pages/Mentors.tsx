                  ...
                  <Card className="card-hover overflow-hidden bg-card/50 backdrop-blur-sm border-border/50 group">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">{mentor.languages.join(", ")}</span>
                      </div>
                    </CardContent>
                    <CardFooter className="pt-3 gap-2">
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="default" size="sm" className="flex-1" onClick={() => setSelectedMentor(mentor.id)}>
                          ...
                          <div className="space-y-6">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm font-medium text-primary">₹{mentor.pricePerHour}/hour</p>
                              </div>
                            </div>
                            <div>
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                {availableSlots.length > 0 ? (
                                  availableSlots.map((slot) => (
                                    <Button key={slot.id} variant="outline" size="sm" className="w-full" onClick={() => handleBookSession(mentor, slot.time)}>
                                      {slot.time}
                                    </Button>
                                  ))
                                ) : (
                                  <p className="col-span-3 text-sm text-muted-foreground text-center py-4">No slots available for this date. Try another day.</p>
                                )}
                              </div>
                            </div>
                          </div>
