  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-muted/20 to-background">
      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-lg">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <Link to="/notes" className="story-link text-sm font-medium text-muted-foreground hover:text-foreground">
              Notes
            </Link>
            <Link to="/events" className="story-link text-sm font-medium text-muted-foreground hover:text-foreground">
              Events
            </Link>
            <Link to="/community" className="story-link text-sm font-medium text-muted-foreground hover:text-foreground">
              Community
            </Link>
            <Link to="/dashboard" className="story-link text-sm font-medium text-muted-foreground hover:text-foreground">
              Dashboard
            </Link>
          </nav>
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        <div className={`container mx-auto px-4 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 left-1/4 h-96 w-96 rounded-full bg-primary/10 blur-3xl animate-float" />
          <div className="absolute -bottom-24 right-1/4 h-96 w-96 rounded-full bg-accent/10 blur-3xl animate-float" style={{ animationDelay: '1s' }} />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group card-hover rounded-xl border border-border/50 bg-card p-6 shadow-sm animate-fade-in"
